<x-layouts.app
    ...
    <div class="flex flex-row gap-2">
        ...
        <div class="flex flex-col gap-2">
            ...
            <h3 class="text-xs font-medium text-gray-800">Sat, 11 Feb at 16:00h</h3>
                <p class="text-xs">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis, fugiat.</p>
