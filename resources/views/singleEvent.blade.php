<x-layouts.app
    ...
    <div class="flex flex-col gap-2">
        ...
        <h2 class="font-semibold text-base text-gray-800 -mt-1">Sat, 11 Feb at 16:00h</h2>
        <p class="text-xs">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, nemo.</p>
    </div>
    <br>
    <hr class="w-full">
    <br>
