  ...
  {{-- <div class="sliderAx h-auto">
    <div id="slider-1" class="container mx-auto">
      ...
      <div class="md:w-1/2">
        ...
        <p class="font-bold text-sm uppercase">{{$event->title}}</p>
        <p class="text-3xl font-bold">{{$event->date}}</p>
        <p class="text-2xl mb-10 leading-none">{{$event->time}}</p>
        <p class="text-2xl mb-10 leading-none">{{$event->location}}</p>
